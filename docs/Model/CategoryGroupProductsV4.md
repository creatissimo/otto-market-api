...
**attributes** | [**\Otto\Client\Model\AttributeDefinitionProductsV4[]**](AttributeDefinitionProductsV4.md) | list of the market place attributes for the categories of this group. | [optional]
...
**additional_requirements** | [**\Otto\Client\Model\AdditionalRequirementProductsV4[]**](AdditionalRequirementProductsV4.md) | a list of general requirements for certain product attributes that apply to all categories in the category group | [optional]
