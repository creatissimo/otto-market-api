...
**attributes** | [**\Otto\Client\Model\AttributeDefinitionProductsV5[]**](AttributeDefinitionProductsV5.md) | list of the market place attributes for the categories of this group. | [optional]
...
**additional_requirements** | [**\Otto\Client\Model\AdditionalRequirementProductsV5[]**](AdditionalRequirementProductsV5.md) | a list of general requirements for certain product attributes that apply to all categories in the category group | [optional]
