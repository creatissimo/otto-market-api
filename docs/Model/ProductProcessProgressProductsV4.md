...
**links** | [**\Otto\Client\Model\ProductProcessResultLinkProductsV4[]**](ProductProcessResultLinkProductsV4.md) | a list of links that can be used to access detailed information about the process result | [optional]
