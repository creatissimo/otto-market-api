...
**links** | [**\Otto\Client\Model\ProductProcessResultLinkProductsV5[]**](ProductProcessResultLinkProductsV5.md) | a list of links that can be used to access detailed information about the process result | [optional]
