...
**roles** | [**\OpenAPI\Client\Model\ProductSafetyAddressRoleProductsV5[]**](ProductSafetyAddressRoleProductsV5.md) | The role(s) of the economic agent to which the address belongs. Allowed values are &#39;DISTRIBUTOR&#39; and &#39;MANUFACTURER&#39;. At least one distributor must be specified. |
