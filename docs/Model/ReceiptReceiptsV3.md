...
**totals_gross_amount** | **object** | Gross amounts of totals summed up over all prices. Only available on receipts of receiptType PURCHASE | [optional]
