...
/**
 * DeveloperV1Api Class Doc Comment
 *
 * @category Class
 * @package  Otto\Client
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation developerV1CreateAccessToken
     *
     * Obtain access token from client ID &amp; client Secret
     *
     * @param  string $client_id identifies the client uniquely (required)
     * @param  string $client_secret secret for the client (required)
     * @param  string $grant_type type of token request. Only supported value is client_credentials (required)
     * @param  string $scope list of scopes that the client wants to be included in the access token (space separated) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['developerV1CreateAccessToken'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ClientCredentialResponseDeveloperV1
     */
    public function developerV1CreateAccessToken($client_id, $client_secret, $grant_type, $scope = null, string $contentType = self::contentTypes['developerV1CreateAccessToken'][0])
    {
        list($response) = $this->developerV1CreateAccessTokenWithHttpInfo($client_id, $client_secret, $grant_type, $scope, $contentType);
        return $response;
    }

    /**
     * Operation developerV1CreateAccessTokenWithHttpInfo
     *
     * Obtain access token from client ID &amp; client Secret
     *
     * @param  string $client_id identifies the client uniquely (required)
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\ClientCredentialResponseDeveloperV1, HTTP status code, HTTP response headers (array of strings)
     */
    public function developerV1CreateAccessTokenWithHttpInfo($client_id, $client_secret, $grant_type, $scope = null, string $contentType = self::contentTypes['developerV1CreateAccessToken'][0])
    {
        $request = $this->developerV1CreateAccessTokenRequest($client_id, $client_secret, $grant_type, $scope, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\ClientCredentialResponseDeveloperV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\ClientCredentialResponseDeveloperV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\ClientCredentialResponseDeveloperV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Otto\Client\Model\ClientCredentialResponseDeveloperV1';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\ClientCredentialResponseDeveloperV1',
    ...
    /**
     * Operation developerV1CreateAccessTokenAsync
     *
     * Obtain access token from client ID &amp; client Secret
     *
     * @param  string $client_id identifies the client uniquely (required)
     ...
     */
    public function developerV1CreateAccessTokenAsync($client_id, $client_secret, $grant_type, $scope = null, string $contentType = self::contentTypes['developerV1CreateAccessToken'][0])
    {
        return $this->developerV1CreateAccessTokenAsyncWithHttpInfo($client_id, $client_secret, $grant_type, $scope, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation developerV1CreateAccessTokenAsyncWithHttpInfo
     *
     * Obtain access token from client ID &amp; client Secret
     *
     * @param  string $client_id identifies the client uniquely (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function developerV1CreateAccessTokenAsyncWithHttpInfo($client_id, $client_secret, $grant_type, $scope = null, string $contentType = self::contentTypes['developerV1CreateAccessToken'][0])
    {
        $returnType = '\Otto\Client\Model\ClientCredentialResponseDeveloperV1';
        $request = $this->developerV1CreateAccessTokenRequest($client_id, $client_secret, $grant_type, $scope, $contentType);
    ...
    /**
     * Create request for operation 'developerV1CreateAccessToken'
     *
     * @param  string $client_id identifies the client uniquely (required)
     * @param  string $client_secret secret for the client (required)
     * @param  string $grant_type type of token request. Only supported value is client_credentials (required)
     ...
     */
    public function developerV1CreateAccessTokenRequest($client_id, $client_secret, $grant_type, $scope = null, string $contentType = self::contentTypes['developerV1CreateAccessToken'][0])
    {

        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling developerV1CreateAccessToken'
            );
        }
        ...
        if ($client_secret === null || (is_array($client_secret) && count($client_secret) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_secret when calling developerV1CreateAccessToken'
            );
        }
        ...
        if ($grant_type === null || (is_array($grant_type) && count($grant_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $grant_type when calling developerV1CreateAccessToken'
            );
        }
    ...
    /**
     * Operation developerV1CreateInstallationAccessToken
     *
     * Obtain installation access token
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     * @param  string $installation_id unique id used to identify installation of app by partner (required)
     * @param  string $scope list of scopes that the client wants to be included in the access token (space separated) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['developerV1CreateInstallationAccessToken'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1
     */
    public function developerV1CreateInstallationAccessToken($app_id, $installation_id, $scope = null, string $contentType = self::contentTypes['developerV1CreateInstallationAccessToken'][0])
    {
        list($response) = $this->developerV1CreateInstallationAccessTokenWithHttpInfo($app_id, $installation_id, $scope, $contentType);
        return $response;
    }

    /**
     * Operation developerV1CreateInstallationAccessTokenWithHttpInfo
     *
     * Obtain installation access token
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1, HTTP status code, HTTP response headers (array of strings)
     */
    public function developerV1CreateInstallationAccessTokenWithHttpInfo($app_id, $installation_id, $scope = null, string $contentType = self::contentTypes['developerV1CreateInstallationAccessToken'][0])
    {
        $request = $this->developerV1CreateInstallationAccessTokenRequest($app_id, $installation_id, $scope, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation developerV1CreateInstallationAccessTokenAsync
     *
     * Obtain installation access token
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function developerV1CreateInstallationAccessTokenAsync($app_id, $installation_id, $scope = null, string $contentType = self::contentTypes['developerV1CreateInstallationAccessToken'][0])
    {
        return $this->developerV1CreateInstallationAccessTokenAsyncWithHttpInfo($app_id, $installation_id, $scope, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation developerV1CreateInstallationAccessTokenAsyncWithHttpInfo
     *
     * Obtain installation access token
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function developerV1CreateInstallationAccessTokenAsyncWithHttpInfo($app_id, $installation_id, $scope = null, string $contentType = self::contentTypes['developerV1CreateInstallationAccessToken'][0])
    {
        $returnType = '\Otto\Client\Model\AppInstallationAccessTokenResponseDeveloperV1';
        $request = $this->developerV1CreateInstallationAccessTokenRequest($app_id, $installation_id, $scope, $contentType);
    ...
    /**
     * Create request for operation 'developerV1CreateInstallationAccessToken'
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     * @param  string $installation_id unique id used to identify installation of app by partner (required)
     * @param  string $scope list of scopes that the client wants to be included in the access token (space separated) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function developerV1CreateInstallationAccessTokenRequest($app_id, $installation_id, $scope = null, string $contentType = self::contentTypes['developerV1CreateInstallationAccessToken'][0])
    {

        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling developerV1CreateInstallationAccessToken'
            );
        }
        ...
        if ($installation_id === null || (is_array($installation_id) && count($installation_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $installation_id when calling developerV1CreateInstallationAccessToken'
            );
        }



        $resourcePath = '/v1/apps/{appId}/installations/{installationId}/accessToken';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation developerV1GetInstallation
     *
     * Get installation for a service provider app
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['developerV1GetInstallation'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\AppInstallationResponseDeveloperV1
     */
    public function developerV1GetInstallation($app_id, string $contentType = self::contentTypes['developerV1GetInstallation'][0])
    {
        list($response) = $this->developerV1GetInstallationWithHttpInfo($app_id, $contentType);
        return $response;
    }

    /**
     * Operation developerV1GetInstallationWithHttpInfo
     *
     * Get installation for a service provider app
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\AppInstallationResponseDeveloperV1, HTTP status code, HTTP response headers (array of strings)
     */
    public function developerV1GetInstallationWithHttpInfo($app_id, string $contentType = self::contentTypes['developerV1GetInstallation'][0])
    {
        $request = $this->developerV1GetInstallationRequest($app_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\AppInstallationResponseDeveloperV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\AppInstallationResponseDeveloperV1' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\AppInstallationResponseDeveloperV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Otto\Client\Model\AppInstallationResponseDeveloperV1';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Otto\Client\Model\AppInstallationResponseDeveloperV1',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation developerV1GetInstallationAsync
     *
     * Get installation for a service provider app
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function developerV1GetInstallationAsync($app_id, string $contentType = self::contentTypes['developerV1GetInstallation'][0])
    {
        return $this->developerV1GetInstallationAsyncWithHttpInfo($app_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation developerV1GetInstallationAsyncWithHttpInfo
     *
     * Get installation for a service provider app
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function developerV1GetInstallationAsyncWithHttpInfo($app_id, string $contentType = self::contentTypes['developerV1GetInstallation'][0])
    {
        $returnType = '\Otto\Client\Model\AppInstallationResponseDeveloperV1';
        $request = $this->developerV1GetInstallationRequest($app_id, $contentType);
    ...
    /**
     * Create request for operation 'developerV1GetInstallation'
     *
     * @param  string $app_id unique id used to identify service provider app (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['developerV1GetInstallation'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function developerV1GetInstallationRequest($app_id, string $contentType = self::contentTypes['developerV1GetInstallation'][0])
    {

        // verify the required parameter 'app_id' is set
        if ($app_id === null || (is_array($app_id) && count($app_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $app_id when calling developerV1GetInstallation'
            );
        }


        $resourcePath = '/v1/apps/{appId}/installation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
