...
class OrdersV4Api
{
     ...
     */
    public function ordersV4CancelPartnerOrderPositionItemsRequest($sales_order_id, $position_item_id)
    {
        ...
        // path params
        if (is_array($position_item_id)) {
            $position_item_id = ObjectSerializer::serializeCollection($position_item_id, 'csv');
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersV4CancelPartnerOrdersRequest($sales_order_id)
    {
        // verify the required parameter 'sales_order_id' is set
        if ($sales_order_id === null || (is_array($sales_order_id) && count($sales_order_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersV4FindPartnerOrdersRequest($from_date = null, $from_order_date = null, $to_order_date = null, $fulfillment_status = null, $limit = 128, $order_direction = 'ASC', $order_column_type = 'ORDER_LIFECYCLE_DATE', $mode = 'BUCKET', $nextcursor = null)
    {
        ...
        if ($from_order_date !== null) {
            if('form' === 'form' && is_array($from_order_date)) {
                foreach($from_order_date as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['fromOrderDate'] = $from_order_date;
            }
        }
        // query params
        if ($to_order_date !== null) {
            if('form' === 'form' && is_array($to_order_date)) {
                foreach($to_order_date as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['toOrderDate'] = $to_order_date;
            }
        }
        // query params
        if ($fulfillment_status !== null) {
            if('form' === 'form' && is_array($fulfillment_status)) {
                ...
                $queryParams['fulfillmentStatus'] = $fulfillment_status;
            }
        }
        // query params
        if ($limit !== null) {
        ...
        if ($order_direction !== null) {
            if('form' === 'form' && is_array($order_direction)) {
                ...
                $queryParams['orderDirection'] = $order_direction;
            }
        }
        // query params
        if ($order_column_type !== null) {
            if('form' === 'form' && is_array($order_column_type)) {
                foreach($order_column_type as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['orderColumnType'] = $order_column_type;
            }
        }
        // query params
        if ($mode !== null) {
        ...
        // query params
        if ($nextcursor !== null) {
            if('form' === 'form' && is_array($nextcursor)) {
                foreach($nextcursor as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersV4GetPartnerOrderByOrderNumberRequest($order_number)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function ordersV4GetPartnerOrderBySalesOrderIdRequest($sales_order_id)
    {
        // verify the required parameter 'sales_order_id' is set
        if ($sales_order_id === null || (is_array($sales_order_id) && count($sales_order_id) === 0)) {
            throw new \InvalidArgumentException(
