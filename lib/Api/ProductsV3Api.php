...
/**
     ...
     */
    public function productsV3GetCategoryGroups($page = null, $limit = null, string $contentType = self::contentTypes['productsV3GetCategoryGroups'][0])
    {
        list($response) = $this->productsV3GetCategoryGroupsWithHttpInfo($page, $limit, $contentType);
        return $response;
    }
     ...
     */
    public function productsV3GetCategoryGroupsWithHttpInfo($page = null, $limit = null, string $contentType = self::contentTypes['productsV3GetCategoryGroups'][0])
    {
        $request = $this->productsV3GetCategoryGroupsRequest($page, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetCategoryGroupsAsync($page = null, $limit = null, string $contentType = self::contentTypes['productsV3GetCategoryGroups'][0])
    {
        return $this->productsV3GetCategoryGroupsAsyncWithHttpInfo($page, $limit, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetCategoryGroupsAsyncWithHttpInfo($page = null, $limit = null, string $contentType = self::contentTypes['productsV3GetCategoryGroups'][0])
    {
        $returnType = '\Otto\Client\Model\CategoryGroupsProductsV3';
        $request = $this->productsV3GetCategoryGroupsRequest($page, $limit, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsV3GetCategoryGroupsRequest($page = null, $limit = null, string $contentType = self::contentTypes['productsV3GetCategoryGroups'][0])
    {
     ...
     */
    public function productsV3GetMarketPlaceStatusList($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        list($response) = $this->productsV3GetMarketPlaceStatusListWithHttpInfo($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $contentType);
        return $response;
    }
     ...
     */
    public function productsV3GetMarketPlaceStatusListWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusListAsync($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        return $this->productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function productsV3GetMarketPlaceStatusListAsyncWithHttpInfo($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
        $returnType = '\Otto\Client\Model\MarketPlaceStatusApiResultProductsV3';
        $request = $this->productsV3GetMarketPlaceStatusListRequest($sku, $product_reference, $category, $brand_id, $from_date, $page, $limit, $market_place_status, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function productsV3GetMarketPlaceStatusListRequest($sku = null, $product_reference = null, $category = null, $brand_id = null, $from_date = null, $page = null, $limit = null, $market_place_status = null, string $contentType = self::contentTypes['productsV3GetMarketPlaceStatusList'][0])
    {
