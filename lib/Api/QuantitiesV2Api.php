...
class QuantitiesV2Api
{
    ...
    {
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsync($available_quantity_request_dtov2_quantities_v2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        return $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($available_quantity_request_dtov2_quantities_v2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($available_quantity_request_dtov2_quantities_v2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {
        $returnType = 'object';
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2, string $contentType = self::contentTypes['quantitiesV2StoreAvailableQuantitiesUsingPOST'][0])
    {

        // verify the required parameter 'available_quantity_request_dtov2_quantities_v2' is set
        if ($available_quantity_request_dtov2_quantities_v2 === null || (is_array($available_quantity_request_dtov2_quantities_v2) && count($available_quantity_request_dtov2_quantities_v2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $available_quantity_request_dtov2_quantities_v2 when calling quantitiesV2StoreAvailableQuantitiesUsingPOST'
            );
        }
        ...
        // for model (json/xml)
        if (isset($available_quantity_request_dtov2_quantities_v2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($available_quantity_request_dtov2_quantities_v2));
            } else {
                $httpBody = $available_quantity_request_dtov2_quantities_v2;
            }
