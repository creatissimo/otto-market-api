...
class QuantitiesV2Api
{
     ...
     */
    public function quantitiesV2GetAvailableQuantitiesRequest($limit = 200, $page = 0)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function quantitiesV2GetAvailableQuantityBySkuRequest($sku)
    {
     ...
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOST($available_quantity_request_dtov2_quantities_v2)
    {
        list($response) = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTWithHttpInfo($available_quantity_request_dtov2_quantities_v2);
        return $response;
    }
     ...
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTWithHttpInfo($available_quantity_request_dtov2_quantities_v2)
    {
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsync($available_quantity_request_dtov2_quantities_v2)
    {
        return $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($available_quantity_request_dtov2_quantities_v2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTAsyncWithHttpInfo($available_quantity_request_dtov2_quantities_v2)
    {
        $returnType = 'object';
        $request = $this->quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function quantitiesV2StoreAvailableQuantitiesUsingPOSTRequest($available_quantity_request_dtov2_quantities_v2)
    {
        ...
        if (isset($available_quantity_request_dtov2_quantities_v2)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($available_quantity_request_dtov2_quantities_v2));
            } else {
