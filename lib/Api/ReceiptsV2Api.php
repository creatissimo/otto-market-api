...
class ReceiptsV2Api
{
     ...
     */
    public function receiptsV2GetReceiptPdfUsingGET3Request($receipt_number)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptsV2GetReceiptUsingGET5Request($receipt_number)
    {
        // verify the required parameter 'receipt_number' is set
        if ($receipt_number === null || (is_array($receipt_number) && count($receipt_number) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptsV2GetReceiptsUsingGET5Request($limit = 128, $page = 1, $type = null, $sales_order_id = null)
    {
