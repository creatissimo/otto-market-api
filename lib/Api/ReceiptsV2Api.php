...
/**
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function receiptsV2GetReceiptPdfUsingGET3($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'][0])
    {
        $this->receiptsV2GetReceiptPdfUsingGET3WithHttpInfo($receipt_number, $contentType);
    }
     ...
     */
    public function receiptsV2GetReceiptPdfUsingGET3WithHttpInfo($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'][0])
    {
        $request = $this->receiptsV2GetReceiptPdfUsingGET3Request($receipt_number, $contentType);
     ...
     */
    public function receiptsV2GetReceiptPdfUsingGET3Async($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'][0])
    {
        return $this->receiptsV2GetReceiptPdfUsingGET3AsyncWithHttpInfo($receipt_number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV2GetReceiptPdfUsingGET3AsyncWithHttpInfo($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'][0])
    {
        $returnType = '';
        $request = $this->receiptsV2GetReceiptPdfUsingGET3Request($receipt_number, $contentType);
     ...
     */
    public function receiptsV2GetReceiptPdfUsingGET3Request($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptPdfUsingGET3'][0])
    {
     ...
     *
     * @param  string $receipt_number ReceiptNumber (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiptsV2GetReceiptUsingGET5'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ReceiptReceiptsV2
     */
    public function receiptsV2GetReceiptUsingGET5($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptUsingGET5'][0])
    {
        list($response) = $this->receiptsV2GetReceiptUsingGET5WithHttpInfo($receipt_number, $contentType);
        return $response;
    }
     ...
     */
    public function receiptsV2GetReceiptUsingGET5WithHttpInfo($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptUsingGET5'][0])
    {
        $request = $this->receiptsV2GetReceiptUsingGET5Request($receipt_number, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\ReceiptReceiptsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\ReceiptReceiptsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\ReceiptReceiptsV2', []),
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV2GetReceiptUsingGET5Async($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptUsingGET5'][0])
    {
        return $this->receiptsV2GetReceiptUsingGET5AsyncWithHttpInfo($receipt_number, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV2GetReceiptUsingGET5AsyncWithHttpInfo($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptUsingGET5'][0])
    {
        $returnType = '\Otto\Client\Model\ReceiptReceiptsV2';
        $request = $this->receiptsV2GetReceiptUsingGET5Request($receipt_number, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptsV2GetReceiptUsingGET5Request($receipt_number, string $contentType = self::contentTypes['receiptsV2GetReceiptUsingGET5'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['receiptsV2GetReceiptsUsingGET5'] to see the possible values for this operation
     *
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ReceiptsListReceiptsV2
     */
    public function receiptsV2GetReceiptsUsingGET5($limit = 128, $page = 1, $type = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV2GetReceiptsUsingGET5'][0])
    {
        list($response) = $this->receiptsV2GetReceiptsUsingGET5WithHttpInfo($limit, $page, $type, $sales_order_id, $contentType);
        return $response;
    }
     ...
     */
    public function receiptsV2GetReceiptsUsingGET5WithHttpInfo($limit = 128, $page = 1, $type = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV2GetReceiptsUsingGET5'][0])
    {
        $request = $this->receiptsV2GetReceiptsUsingGET5Request($limit, $page, $type, $sales_order_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\ReceiptsListReceiptsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\ReceiptsListReceiptsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\ReceiptsListReceiptsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV2GetReceiptsUsingGET5Async($limit = 128, $page = 1, $type = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV2GetReceiptsUsingGET5'][0])
    {
        return $this->receiptsV2GetReceiptsUsingGET5AsyncWithHttpInfo($limit, $page, $type, $sales_order_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV2GetReceiptsUsingGET5AsyncWithHttpInfo($limit = 128, $page = 1, $type = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV2GetReceiptsUsingGET5'][0])
    {
        $returnType = '\Otto\Client\Model\ReceiptsListReceiptsV2';
        $request = $this->receiptsV2GetReceiptsUsingGET5Request($limit, $page, $type, $sales_order_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptsV2GetReceiptsUsingGET5Request($limit = 128, $page = 1, $type = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV2GetReceiptsUsingGET5'][0])
    {

        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling ReceiptsV2Api.receiptsV2GetReceiptsUsingGET5, must be bigger than or equal to 1.');
        }
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $sales_order_id,
            'sales_order_id', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
