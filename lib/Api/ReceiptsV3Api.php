...
/**
     ...
     */
    public function receiptsV3GetReceiptsUsingGET5($limit = 128, $page = 1, $receipt_types = null, $from = null, $to = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV3GetReceiptsUsingGET5'][0])
    {
        list($response) = $this->receiptsV3GetReceiptsUsingGET5WithHttpInfo($limit, $page, $receipt_types, $from, $to, $sales_order_id, $contentType);
        return $response;
    }
     ...
     */
    public function receiptsV3GetReceiptsUsingGET5WithHttpInfo($limit = 128, $page = 1, $receipt_types = null, $from = null, $to = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV3GetReceiptsUsingGET5'][0])
    {
        $request = $this->receiptsV3GetReceiptsUsingGET5Request($limit, $page, $receipt_types, $from, $to, $sales_order_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV3GetReceiptsUsingGET5Async($limit = 128, $page = 1, $receipt_types = null, $from = null, $to = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV3GetReceiptsUsingGET5'][0])
    {
        return $this->receiptsV3GetReceiptsUsingGET5AsyncWithHttpInfo($limit, $page, $receipt_types, $from, $to, $sales_order_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function receiptsV3GetReceiptsUsingGET5AsyncWithHttpInfo($limit = 128, $page = 1, $receipt_types = null, $from = null, $to = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV3GetReceiptsUsingGET5'][0])
    {
        $returnType = '\Otto\Client\Model\ReceiptsListReceiptsV3';
        $request = $this->receiptsV3GetReceiptsUsingGET5Request($limit, $page, $receipt_types, $from, $to, $sales_order_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function receiptsV3GetReceiptsUsingGET5Request($limit = 128, $page = 1, $receipt_types = null, $from = null, $to = null, $sales_order_id = null, string $contentType = self::contentTypes['receiptsV3GetReceiptsUsingGET5'][0])
    {
