...
class ReturnsV2Api
{
     ...
     */
    public function returnsV2GetPositionItemsForUsingGETV2Request($limit = 10, $page = 1, $status = null)
    {
     ...
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2($accepted_partner_return_v2_returns_v2)
    {
        list($response) = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($accepted_partner_return_v2_returns_v2);
        return $response;
    }
     ...
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($accepted_partner_return_v2_returns_v2)
    {
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Async($accepted_partner_return_v2_returns_v2)
    {
        return $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($accepted_partner_return_v2_returns_v2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($accepted_partner_return_v2_returns_v2)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2)
    {
        ...
        if (isset($accepted_partner_return_v2_returns_v2)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($accepted_partner_return_v2_returns_v2));
            } else {
     ...
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2($rejected_partner_return_v2_returns_v2)
    {
        list($response) = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejected_partner_return_v2_returns_v2);
        return $response;
    }
     ...
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejected_partner_return_v2_returns_v2)
    {
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Async($rejected_partner_return_v2_returns_v2)
    {
        return $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejected_partner_return_v2_returns_v2)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejected_partner_return_v2_returns_v2)
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2)
    {
        ...
        if (isset($rejected_partner_return_v2_returns_v2)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($rejected_partner_return_v2_returns_v2));
            } else {
