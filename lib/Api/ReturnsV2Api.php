...
/**
     ...
     * @return \Otto\Client\Model\PositionItemListReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2
     */
    ...
    {
        list($response) = $this->returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit, $page, $status, $contentType);
        return $response;
    }
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\PositionItemListReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnsV2GetPositionItemsForUsingGETV2WithHttpInfo($limit = 10, $page = 1, $status = null, string $contentType = self::contentTypes['returnsV2GetPositionItemsForUsingGETV2'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Otto\Client\Model\PositionItemListReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\PositionItemListReturnsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\PositionItemListReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\Otto\Client\Model\ApiErrorResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\ApiErrorResponseReturnsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\ApiErrorResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     *
     * @param  \Otto\Client\Model\AcceptedPartnerReturnV2ReturnsV2 $accepted_partner_return_v2_returns_v2 acceptedPartnerReturn (required)
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2($accepted_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        list($response) = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($accepted_partner_return_v2_returns_v2, $contentType);
        return $response;
    }
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2WithHttpInfo($accepted_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 207:
                    if ('\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\AcceptedReturnMultiStatusResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Async($accepted_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        return $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($accepted_partner_return_v2_returns_v2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2AsyncWithHttpInfo($accepted_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2Request($accepted_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'][0])
    {

        // verify the required parameter 'accepted_partner_return_v2_returns_v2' is set
        if ($accepted_partner_return_v2_returns_v2 === null || (is_array($accepted_partner_return_v2_returns_v2) && count($accepted_partner_return_v2_returns_v2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $accepted_partner_return_v2_returns_v2 when calling returnsV2ReceiveAcceptedReturnsV2UsingPOSTV2'
            );
        }
        ...
        // for model (json/xml)
        if (isset($accepted_partner_return_v2_returns_v2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($accepted_partner_return_v2_returns_v2));
            } else {
                $httpBody = $accepted_partner_return_v2_returns_v2;
            }
     ...
     *
     * @param  \Otto\Client\Model\RejectedPartnerReturnV2ReturnsV2 $rejected_partner_return_v2_returns_v2 rejectedPartnerReturn (required)
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return object|\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2($rejected_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        list($response) = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejected_partner_return_v2_returns_v2, $contentType);
        return $response;
    }
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of object|\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2|\Otto\Client\Model\ApiErrorResponseReturnsV2, HTTP status code, HTTP response headers (array of strings)
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2WithHttpInfo($rejected_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 207:
                    if ('\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Otto\Client\Model\RejectedReturnMultiStatusResponseReturnsV2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Async($rejected_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        return $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejected_partner_return_v2_returns_v2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2AsyncWithHttpInfo($rejected_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {
        $returnType = 'object';
        $request = $this->returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function returnsV2ReceiveRejectedReturnsV2UsingPOSTV2Request($rejected_partner_return_v2_returns_v2, string $contentType = self::contentTypes['returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'][0])
    {

        // verify the required parameter 'rejected_partner_return_v2_returns_v2' is set
        if ($rejected_partner_return_v2_returns_v2 === null || (is_array($rejected_partner_return_v2_returns_v2) && count($rejected_partner_return_v2_returns_v2) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $rejected_partner_return_v2_returns_v2 when calling returnsV2ReceiveRejectedReturnsV2UsingPOSTV2'
            );
        }
        ...
        // for model (json/xml)
        if (isset($rejected_partner_return_v2_returns_v2)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($rejected_partner_return_v2_returns_v2));
            } else {
                $httpBody = $rejected_partner_return_v2_returns_v2;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
