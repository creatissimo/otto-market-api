...
class ShipmentsV1Api
{
     ...
     * @return void
     */
    public function shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOST($carrier, $tracking_number, $position_item_shipments_v1)
    {
        $this->shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTWithHttpInfo($carrier, $tracking_number, $position_item_shipments_v1);
    }
     ...
     */
    public function shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTWithHttpInfo($carrier, $tracking_number, $position_item_shipments_v1)
    {
        $request = $this->shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTRequest($carrier, $tracking_number, $position_item_shipments_v1);
     ...
     */
    public function shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTAsync($carrier, $tracking_number, $position_item_shipments_v1)
    {
        return $this->shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTAsyncWithHttpInfo($carrier, $tracking_number, $position_item_shipments_v1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTAsyncWithHttpInfo($carrier, $tracking_number, $position_item_shipments_v1)
    {
        $returnType = '';
        $request = $this->shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTRequest($carrier, $tracking_number, $position_item_shipments_v1);
     ...
     */
    public function shipmentsV1AppendPositionItemsByCarrierAndTrackingNumberUsingPOSTRequest($carrier, $tracking_number, $position_item_shipments_v1)
    {
        ...
        if (isset($position_item_shipments_v1)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($position_item_shipments_v1));
            } else {
     ...
     * @return void
     */
    public function shipmentsV1AppendPositionItemsUsingPOST($shipment_id, $position_item_shipments_v1)
    {
        $this->shipmentsV1AppendPositionItemsUsingPOSTWithHttpInfo($shipment_id, $position_item_shipments_v1);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function shipmentsV1AppendPositionItemsUsingPOSTWithHttpInfo($shipment_id, $position_item_shipments_v1)
    {
        $request = $this->shipmentsV1AppendPositionItemsUsingPOSTRequest($shipment_id, $position_item_shipments_v1);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsV1AppendPositionItemsUsingPOSTAsync($shipment_id, $position_item_shipments_v1)
    {
        return $this->shipmentsV1AppendPositionItemsUsingPOSTAsyncWithHttpInfo($shipment_id, $position_item_shipments_v1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsV1AppendPositionItemsUsingPOSTAsyncWithHttpInfo($shipment_id, $position_item_shipments_v1)
    {
        $returnType = '';
        $request = $this->shipmentsV1AppendPositionItemsUsingPOSTRequest($shipment_id, $position_item_shipments_v1);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentsV1AppendPositionItemsUsingPOSTRequest($shipment_id, $position_item_shipments_v1)
    {
     ...
     */
    public function shipmentsV1CreatedAndSentShipmentUsingPOST($create_shipment_request_shipments_v1)
    {
        list($response) = $this->shipmentsV1CreatedAndSentShipmentUsingPOSTWithHttpInfo($create_shipment_request_shipments_v1);
        return $response;
    }
     ...
     */
    public function shipmentsV1CreatedAndSentShipmentUsingPOSTWithHttpInfo($create_shipment_request_shipments_v1)
    {
        $request = $this->shipmentsV1CreatedAndSentShipmentUsingPOSTRequest($create_shipment_request_shipments_v1);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsV1CreatedAndSentShipmentUsingPOSTAsync($create_shipment_request_shipments_v1)
    {
        return $this->shipmentsV1CreatedAndSentShipmentUsingPOSTAsyncWithHttpInfo($create_shipment_request_shipments_v1)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function shipmentsV1CreatedAndSentShipmentUsingPOSTAsyncWithHttpInfo($create_shipment_request_shipments_v1)
    {
        $returnType = '\Otto\Client\Model\CreateShipmentResponseShipmentsV1';
        $request = $this->shipmentsV1CreatedAndSentShipmentUsingPOSTRequest($create_shipment_request_shipments_v1);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentsV1CreatedAndSentShipmentUsingPOSTRequest($create_shipment_request_shipments_v1)
    {
        ...
        if (isset($create_shipment_request_shipments_v1)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($create_shipment_request_shipments_v1));
            } else {
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ShipmentListShipmentsV1|\Otto\Client\Model\InternalServerErrorGetShipmentListShipmentsV1
     */
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Otto\Client\Model\ShipmentListShipmentsV1|\Otto\Client\Model\InternalServerErrorGetShipmentListShipmentsV1, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentsV1ListShipmentsUsingGETRequest($datefrom, $limit = 25, $next = null)
    {
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ShipmentShipmentsV1|\Otto\Client\Model\ForbiddenGetShipmentByTrackingNumberShipmentsV1|\Otto\Client\Model\NotFoundGetShipmentByTrackingNumberShipmentsV1|\Otto\Client\Model\InternalServerErrorGetShipmentByTrackingNumberShipmentsV1
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentsV1ShipmentByCarrierAndTrackingNumberUsingGETRequest($carrier, $tracking_number)
    {
        // verify the required parameter 'carrier' is set
        if ($carrier === null || (is_array($carrier) && count($carrier) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @throws \Otto\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Otto\Client\Model\ShipmentShipmentsV1|\Otto\Client\Model\ForbiddenGetShipmentByShipmentIdShipmentsV1|\Otto\Client\Model\NotFoundGetShipmentByShipmentIdShipmentsV1|\Otto\Client\Model\InternalServerErrorGetShipmentByShipmentIdShipmentsV1
     */
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function shipmentsV1ShipmentUsingGETRequest($shipment_id)
    {
        // verify the required parameter 'shipment_id' is set
        if ($shipment_id === null || (is_array($shipment_id) && count($shipment_id) === 0)) {
            throw new \InvalidArgumentException(
