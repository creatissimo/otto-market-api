 ...
 */
class AcceptedStatusDataReturnsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AcceptedStatusData__Returns-V2';
