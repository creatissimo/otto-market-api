 ...
 */
class ActiveStatusListResponseProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveStatusListResponse__Products-V2';
    ...
    */
     ...
     * Gets status
     *
     * @return \Otto\Client\Model\ActiveStatusProductsV2[]|null
     */
     ...
     * Sets status
     *
     * @param \Otto\Client\Model\ActiveStatusProductsV2[]|null $status status
     *
     * @return self
     */
