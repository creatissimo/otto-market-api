 ...
 */
class ActiveStatusProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveStatus__Products-V2';
    ...
    */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified the timestamp (GMT date and time) of the last modification of the active status
     *
     * @return self
     */
