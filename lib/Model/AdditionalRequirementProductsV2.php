 ...
 */
class AdditionalRequirementProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AdditionalRequirement__Products-V2';
    ...
    */
     ...
     * Sets json_path
     *
     * @param string|null $json_path the JSON path leading to the specific product attribute.
     *
     * @return self
     */
     ...
     * Gets condition
     *
     * @return \Otto\Client\Model\ConditionProductsV2|null
     */
     ...
     * Sets condition
     *
     * @param \Otto\Client\Model\ConditionProductsV2|null $condition condition
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $feature_relevance a list of feature relevances that can describe the reason for the requirement.
     *
     * @return self
     */
