...
class AddressReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets house_number
     *
     * @param string|null $house_number House number of  address  Available for sales orders placed after 23rd Sep. 2021. For older sales orders the house number is part of the field street and this field is not shown at all
     *
     * @return self
     */
     ...
     * Sets addition
     *
     * @param string|null $addition Additional information of the address  Can be used to provide additional information of address
     *
     * @return self
     */
