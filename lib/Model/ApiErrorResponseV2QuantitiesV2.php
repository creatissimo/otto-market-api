 ...
 */
class ApiErrorResponseV2QuantitiesV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiErrorResponseV2__Quantities-V2';
