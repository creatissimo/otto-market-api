<?php
/**
 * AppInstallationAccessTokenResponseDeveloperV1
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * AppInstallationAccessTokenResponseDeveloperV1 Class Doc Comment
 *
 * @category Class
 * @package  Otto\Client
 * @author   OpenAPI Generator team
 ...
 */
class AppInstallationAccessTokenResponseDeveloperV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppInstallationAccessTokenResponse__Developer-V1';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token installation access token
     *
     * @return self
     */
     ...
     * Sets expires_in
     *
     * @param float|null $expires_in identifies token expiry
     *
     * @return self
     */
