 ...
 */
class AttributeDefinitionProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttributeDefinition__Products-V2';
