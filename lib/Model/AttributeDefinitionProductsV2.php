...
class AttributeDefinitionProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['attribute_group'] = $data['attribute_group'] ?? null;
        $this->container['type'] = $data['type'] ?? null;
        $this->container['multi_value'] = $data['multi_value'] ?? null;
        $this->container['unit'] = $data['unit'] ?? null;
        $this->container['unit_display_name'] = $data['unit_display_name'] ?? null;
        $this->container['allowed_values'] = $data['allowed_values'] ?? null;
        $this->container['feature_relevance'] = $data['feature_relevance'] ?? null;
        $this->container['related_media_assets'] = $data['related_media_assets'] ?? null;
