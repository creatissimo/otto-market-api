 ...
 */
class AvailableQuantitySingleResponseDTOV2QuantitiesV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AvailableQuantitySingleResponseDTOV2__Quantities-V2';
    ...
    */
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity > 999999999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantitySingleResponseDTOV2QuantitiesV2., must be smaller than or equal to 999999999.');
        }
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling AvailableQuantitySingleResponseDTOV2QuantitiesV2., must be bigger than or equal to 0.');
        }
