 ...
 */
class CategoryGroupProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryGroup__Products-V2';
    ...
    */
     ...
     * Gets attributes
     *
     * @return \Otto\Client\Model\AttributeDefinitionProductsV2[]|null
     */
     ...
     * Sets attributes
     *
     * @param \Otto\Client\Model\AttributeDefinitionProductsV2[]|null $attributes list of the market place attributes for the categories of this group.
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified last modification date of the category.
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\AdditionalRequirementProductsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\AdditionalRequirementProductsV2[]|null $additional_requirements a list of general requirements for certain product attributes that apply to all categories in the category group
     *
     * @return self
     */
