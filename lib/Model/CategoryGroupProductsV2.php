...
class CategoryGroupProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['category_group'] = $data['category_group'] ?? null;
        $this->container['categories'] = $data['categories'] ?? null;
        $this->container['variation_themes'] = $data['variation_themes'] ?? null;
        $this->container['title'] = $data['title'] ?? null;
        $this->container['attributes'] = $data['attributes'] ?? null;
        $this->container['last_modified'] = $data['last_modified'] ?? null;
        $this->container['additional_requirements'] = $data['additional_requirements'] ?? null;
    }
