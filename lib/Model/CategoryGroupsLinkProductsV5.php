 ...
 */
class CategoryGroupsLinkProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CategoryGroupsLink__Products-V5';
