 ...
 */
class ClientCredentialResponseDeveloperV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClientCredentialResponse__Developer-V1';
    ...
    */
     ...
     * Sets scope
     *
     * @param string|null $scope scopes attached to the token
     *
     * @return self
     */
