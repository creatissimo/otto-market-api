 ...
 */
class ConditionProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Condition__Products-V2';
     ...
     * Sets json_path
     *
     * @param string|null $json_path the JSON path that leads to the attribute value.
     *
     * @return self
     */
