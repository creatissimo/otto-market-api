 ...
 */
class ContentChangesApiResultProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentChangesApiResult__Products-V2';
    ...
    {
        $this->setIfExists('content_changes', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Otto\Client\Model\ContentChangeProductsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\ContentChangeProductsV2[]|null $content_changes content_changes
     *
     * @return self
     */
    public function setContentChanges($content_changes)
    {
        if (is_null($content_changes)) {
            throw new \InvalidArgumentException('non-nullable content_changes cannot be null');
        }
