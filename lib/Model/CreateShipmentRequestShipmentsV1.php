...
class CreateShipmentRequestShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['position_items']) < 1)) {
    ...
    public function setPositionItems($position_items)
    {
        ...
        if ((count($position_items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $position_items when calling CreateShipmentRequestShipmentsV1., number of items must be greater than or equal to 1.');
        }
