    ...
    */
    ...
    public function setDefaultProcessingTime($default_processing_time)
    {
        ...
        if (($default_processing_time > 99)) {
            throw new \InvalidArgumentException('invalid value for $default_processing_time when calling CreateShippingProfileRequestShippingProfilesV1., must be smaller than or equal to 99.');
        }
        if (($default_processing_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $default_processing_time when calling CreateShippingProfileRequestShippingProfilesV1., must be bigger than or equal to 1.');
        }
    ...
    public function setTransportTime($transport_time)
    {
        ...
        if (($transport_time > 99)) {
            throw new \InvalidArgumentException('invalid value for $transport_time when calling CreateShippingProfileRequestShippingProfilesV1., must be smaller than or equal to 99.');
        }
        if (($transport_time < 1)) {
            throw new \InvalidArgumentException('invalid value for $transport_time when calling CreateShippingProfileRequestShippingProfilesV1., must be bigger than or equal to 1.');
        }
