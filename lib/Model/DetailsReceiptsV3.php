...
class DetailsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const REASON_ITEM_FOR_FREE = 'GOODWILL_ITEM_FOR_FREE';
    public const REASON_ITEM_RETURN_REJECTED = 'GOODWILL_ITEM_RETURN_REJECTED';
    public const REASON_ITEM_DISCOUNT_EXPIRED = 'GOODWILL_ITEM_DISCOUNT_EXPIRED';
    public const REASON_OTHER = 'GOODWILL_OTHER';
