...
class DetailsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Discount code applied to the order to get a reduction. Available when reduction is of type PARTNER_DISCOUNT or MARKETPLACE_FINANCED_DISCOUNT
     *
     * @return self
     */
     ...
     *
     * @param string|null $linked_receipt_number Allows to link an earlier purchase or (partial)refund receipt by human-readable identifier.  If PriceModification object is of type: DEFECT_COMPENSATION: In case of previous (partial) refunds this field contains the human-readable identifier of the partial refund with which the previous refund was made
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $linked_receipt_creation_date Allows to show creation date of linked earlier purchase or (partial)refund receipt.  If PriceModification object is of type: DEFECT_COMPENSATION: In case of previous (partial) refunds this field contains the creation date of linked receipt with which the previous refund was made. (ISO-8601 format)
     *
     * @return self
     */
