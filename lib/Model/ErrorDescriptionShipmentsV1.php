...
class ErrorDescriptionShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets json_path
     *
     * @param string|null $json_path The JSON path points either to the object or the value that caused the error. The JSON path could consists of JSON properties and indexes.
     *
     * @return self
     */
