...
class InitialDeliveryFeeOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('delivery_fee_amount', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($delivery_fee_amount)) {
            throw new \InvalidArgumentException('non-nullable delivery_fee_amount cannot be null');
        }
