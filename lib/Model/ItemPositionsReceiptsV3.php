 ...
 */
class ItemPositionsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ItemPositions__Receipts-V3';
    ...
    */
     ...
     * Sets line_number
     *
     * @param int|null $line_number Number of line item in which the information is printed on the pdf document.  This information is not reliably provided for older receipts
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku Stock keeping unit of item. Unique item identifier on partner side.  This information is not reliably provided for older receipts
     *
     * @return self
     */
