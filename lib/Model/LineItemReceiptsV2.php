 ...
 */
class LineItemReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LineItem__Receipts-V2';
    ...
    protected static $openAPITypes = [
        'unit_price' => '\Otto\Client\Model\LineItemReceiptsV2UnitPrice',
        'price_to_pay' => '\Otto\Client\Model\LineItemReceiptsV2PriceToPay',
        'total_discount' => '\Otto\Client\Model\LineItemReceiptsV2TotalDiscount',
        'discount_details' => '\Otto\Client\Model\DiscountDetailsReceiptsV2',
        'vat_rate' => 'float',
        'quantity' => 'int',
        'total' => '\Otto\Client\Model\LineItemReceiptsV2Total',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('price_to_pay', $data ?? [], null);
        ...
        $this->setIfExists('partial_refund_history', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets unit_price
     *
     * @return \Otto\Client\Model\LineItemReceiptsV2UnitPrice
     */
     ...
     * Sets unit_price
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2UnitPrice $unit_price unit_price
     *
     * @return self
     */
     ...
     * Gets price_to_pay
     *
     * @return \Otto\Client\Model\LineItemReceiptsV2PriceToPay
     */
     ...
     * Sets price_to_pay
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2PriceToPay $price_to_pay price_to_pay
     *
     * @return self
     */
    public function setPriceToPay($price_to_pay)
    {
        if (is_null($price_to_pay)) {
            throw new \InvalidArgumentException('non-nullable price_to_pay cannot be null');
        }
     ...
     * Gets total_discount
     *
     * @return \Otto\Client\Model\LineItemReceiptsV2TotalDiscount|null
     */
     ...
     * Sets total_discount
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2TotalDiscount|null $total_discount total_discount
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\DiscountDetailsReceiptsV2|null
     */
     ...
     *
     * @param \Otto\Client\Model\DiscountDetailsReceiptsV2|null $discount_details discount_details
     *
     * @return self
     */
     ...
     * Gets total
     *
     * @return \Otto\Client\Model\LineItemReceiptsV2Total
     */
     ...
     * Sets total
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2Total $total total
     *
     * @return self
     */
     ...
     * Sets dimensions
     *
     * @param string|null $dimensions Characteristics of a product like color, size or extension separated by commas.Shown on the product detail page when choosing the product. It's part of the unique description of an ordered product on a receipt.
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\PartialRefundReceiptsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\PartialRefundReceiptsV2[]|null $partial_refund_history List of all partial refunds that were processed for different position items. In case there were no prior partial reimbursements, then this section will not be available.
     *
     * @return self
     */
    public function setPartialRefundHistory($partial_refund_history)
    {
        if (is_null($partial_refund_history)) {
            throw new \InvalidArgumentException('non-nullable partial_refund_history cannot be null');
        }
