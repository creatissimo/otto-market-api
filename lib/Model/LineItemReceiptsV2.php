...
class LineItemReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['price_to_pay'] = $data['price_to_pay'] ?? null;
        $this->container['total_discount'] = $data['total_discount'] ?? null;
        $this->container['discount_details'] = $data['discount_details'] ?? null;
        $this->container['vat_rate'] = $data['vat_rate'] ?? null;
        $this->container['quantity'] = $data['quantity'] ?? null;
        $this->container['total'] = $data['total'] ?? null;
        $this->container['position_item_ids'] = $data['position_item_ids'] ?? null;
        ...
        $this->container['partial_refund_history'] = $data['partial_refund_history'] ?? null;
    }
     ...
     * Sets unit_price
     *
     * @param object $unit_price The original unit gross price for a single item of this position before discount. Always displayed positively.
     *
     * @return self
     */
     ...
     * Sets price_to_pay
     *
     * @param object $price_to_pay The billed unit gross price for a single position item of this position after discount (if there is any). Always displayed positively.
     *
     * @return self
     */
     ...
     * Sets total_discount
     *
     * @param object|null $total_discount The total amount of discount of this lineItem (= discount per item * qantity). Values are always positive.
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param object $total Total gross price of this position.In case of purchase receipts it's calculated out of unit price and quantity.In case of refund or partial refund receipts, it's the granted price.Always displayed positively.
     *
     * @return self
     */
