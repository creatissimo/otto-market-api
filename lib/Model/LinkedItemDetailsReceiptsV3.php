...
class LinkedItemDetailsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string|null $item_partner_name Name of the partner who sold the linked item.   Displayed only if the partner is different from partner of the receipt
     *
     * @return self
     */
     ...
     * Sets sku
     *
     * @param string|null $sku Stock keeping unit of the linked item. Unique item identifier on partner side
     *
     * @return self
     */
