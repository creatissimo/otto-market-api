 ...
 */
class MarketPlaceStatusApiLinkProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceStatusApiLink__Products-V5';
