 ...
 */
class MarketPlaceStatusApiResultProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceStatusApiResult__Products-V2';
    ...
    {
        $this->setIfExists('market_place_status', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Otto\Client\Model\MarketPlaceStatusProductsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\MarketPlaceStatusProductsV2[]|null $market_place_status market_place_status
     *
     * @return self
     */
    public function setMarketPlaceStatus($market_place_status)
    {
        if (is_null($market_place_status)) {
            throw new \InvalidArgumentException('non-nullable market_place_status cannot be null');
        }
     ...
     * Sets links
     *
     * @param \Otto\Client\Model\LinkProductsV2[]|null $links a list of links that can be used for pagination.
     *
     * @return self
     */
