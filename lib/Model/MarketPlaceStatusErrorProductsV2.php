 ...
 */
class MarketPlaceStatusErrorProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceStatusError__Products-V2';
