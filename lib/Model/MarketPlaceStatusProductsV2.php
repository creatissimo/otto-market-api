 ...
 */
class MarketPlaceStatusProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarketPlaceStatus__Products-V2';
     ...
     * Gets errors
     *
     * @return \Otto\Client\Model\MarketPlaceStatusErrorProductsV2[]|null
     */
     ...
     * Sets errors
     *
     * @param \Otto\Client\Model\MarketPlaceStatusErrorProductsV2[]|null $errors errors that occurred when processing the variation
     *
     * @return self
     */
     ...
     * Gets information
     *
     * @return \Otto\Client\Model\MarketPlaceStatusInformationProductsV2[]|null
     */
     ...
     * Sets information
     *
     * @param \Otto\Client\Model\MarketPlaceStatusInformationProductsV2[]|null $information information for product optimization on the OTTO market place
     *
     * @return self
     */
     ...
     * Gets links
     *
     * @return \Otto\Client\Model\MarketPlaceStatusLinkProductsV2[]|null
     */
     ...
     * Sets links
     *
     * @param \Otto\Client\Model\MarketPlaceStatusLinkProductsV2[]|null $links contains the link to the partner variation data and to the product in OTTO shop
     *
     * @return self
     */
     ...
     * Sets last_modified
     *
     * @param \DateTime|null $last_modified last change of the marketplace status
     *
     * @return self
     */
