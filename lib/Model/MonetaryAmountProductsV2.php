 ...
 */
class MonetaryAmountProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MonetaryAmount__Products-V2';
    ...
    */
     ...
     * Sets amount
     *
     * @param float|null $amount Holds the value of the monetary amount expressed in a currency, e.g. euros. The number format expects a decimal point, like 10.99 and may only contain two decimal places. Numbers without a decimal point are taken as a unit of the given currency, e.g. 10 is taken as 10 euros.
     *
     * @return self
     */
