    ...
    */
    ...
    public function setPositionItems($position_items)
    {
        ...
        if ((count($position_items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $position_items when calling MultiparcelCreateShipmentRequestShipmentsV1., number of items must be greater than or equal to 1.');
        }
