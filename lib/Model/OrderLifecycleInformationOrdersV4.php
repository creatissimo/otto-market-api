...
class OrderLifecycleInformationOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('lifecycle_change_date', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($lifecycle_change_date)) {
            throw new \InvalidArgumentException('non-nullable lifecycle_change_date cannot be null');
        }
