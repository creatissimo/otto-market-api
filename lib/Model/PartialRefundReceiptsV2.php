 ...
 */
class PartialRefundReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartialRefund__Receipts-V2';
    ...
    protected static $openAPITypes = [
        ...
        'partial_refund_amount' => '\Otto\Client\Model\PartialRefundReceiptsV2PartialRefundAmount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('receipt_creation_date', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($receipt_creation_date)) {
            throw new \InvalidArgumentException('non-nullable receipt_creation_date cannot be null');
        }
     ...
     *
     * @return \Otto\Client\Model\PartialRefundReceiptsV2PartialRefundAmount
     */
     ...
     *
     * @param \Otto\Client\Model\PartialRefundReceiptsV2PartialRefundAmount $partial_refund_amount partial_refund_amount
     *
     * @return self
     */
