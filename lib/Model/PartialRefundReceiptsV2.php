...
class PartialRefundReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['receipt_creation_date'] = $data['receipt_creation_date'] ?? null;
        $this->container['partial_refund_amount'] = $data['partial_refund_amount'] ?? null;
    }
     ...
     *
     * @param object $partial_refund_amount Amount which was partially reimbursed
     *
     * @return self
     */
