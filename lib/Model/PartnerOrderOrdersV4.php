...
class PartnerOrderOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['order_lifecycle_information'] = $data['order_lifecycle_information'] ?? null;
        $this->container['initial_delivery_fees'] = $data['initial_delivery_fees'] ?? null;
        $this->container['initial_discounts'] = $data['initial_discounts'] ?? null;
