...
class PartnerReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['legal_representatives'] = $data['legal_representatives'] ?? null;
        $this->container['district_court'] = $data['district_court'] ?? null;
        $this->container['head_of_supervisory_board'] = $data['head_of_supervisory_board'] ?? null;
    }
