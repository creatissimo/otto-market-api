 ...
 */
class PartnerReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Partner__Receipts-V2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('legal_representatives', $data ?? [], null);
        $this->setIfExists('district_court', $data ?? [], null);
    ...
    */
     ...
     * Sets shop_name
     *
     * @param string|null $shop_name Alias name used in customer journey
     *
     * @return self
     */
     ...
     *
     * @param string|null $register_number Commercial register number. Unique in context of the district court.
     *
     * @return self
     */
    public function setRegisterNumber($register_number)
    {
        if (is_null($register_number)) {
            throw new \InvalidArgumentException('non-nullable register_number cannot be null');
        }
    ...
    {
        if (is_null($legal_representatives)) {
            throw new \InvalidArgumentException('non-nullable legal_representatives cannot be null');
        }
     ...
     * Sets district_court
     *
     * @param string|null $district_court District court where the company is registered.
     *
     * @return self
     */
    public function setDistrictCourt($district_court)
    {
        if (is_null($district_court)) {
            throw new \InvalidArgumentException('non-nullable district_court cannot be null');
        }
     ...
     *
     * @param string|null $head_of_supervisory_board The partner's head of supervisory board.
     *
     * @return self
     */
