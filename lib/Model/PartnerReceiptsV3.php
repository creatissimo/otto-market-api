...
class PartnerReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets register_court
     *
     * @param string|null $register_court Court where the company is registered. Information exists if it's maintained in partner core data.  ATTENTION: In previous version the information was called districtCourt
     *
     * @return self
     */
     ...
     *
     * @param string|null $commercial_register_number Commercial register number. Unique in context of register court. Information exists if it's maintained in partner core data.  ATTENTION: In previous version the information was called registerNumber
     *
     * @return self
     */
     ...
     *
     * @param string|null $head_of_supervisory_board The partner's head of supervisory board. Information exists if it's maintained in partner core data
     *
     * @return self
     */
     ...
     * Sets shop_name
     *
     * @param string|null $shop_name Alias name of partner. Information exists if it's maintained in partner core data
     *
     * @return self
     */
     ...
     *
     * @param string|null $weee_registration_number WEEE registration number of partner. Information exists if it's maintained in partner core data
     *
     * @return self
     */
