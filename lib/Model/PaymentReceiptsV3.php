...
class PaymentReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $installment_count For payment methods with installments, this attribute indicates how many installments the customer has chosen when placing the order.  Only available on receipts of receiptType PURCHASE. This information is not reliably provided for older receipts
     *
     * @return self
     */
