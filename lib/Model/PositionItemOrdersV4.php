...
class PositionItemOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['position_item_id'] = $data['position_item_id'] ?? null;
        $this->container['fulfillment_status'] = $data['fulfillment_status'] ?? null;
        $this->container['delivery_service_hes'] = $data['delivery_service_hes'] ?? null;
        $this->container['item_value_gross_price'] = $data['item_value_gross_price'] ?? null;
        $this->container['item_value_reduced_gross_price'] = $data['item_value_reduced_gross_price'] ?? null;
        $this->container['item_value_discount'] = $data['item_value_discount'] ?? null;
        $this->container['product'] = $data['product'] ?? null;
        $this->container['tracking_info'] = $data['tracking_info'] ?? null;
        $this->container['expected_delivery_date'] = $data['expected_delivery_date'] ?? null;
        $this->container['sent_date'] = $data['sent_date'] ?? null;
        $this->container['returned_date'] = $data['returned_date'] ?? null;
        ...
        $this->container['processable_date'] = $data['processable_date'] ?? null;
        $this->container['weee_pickup'] = $data['weee_pickup'] ?? null;
    }
