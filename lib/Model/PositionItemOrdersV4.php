...
class PositionItemOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('delivery_service_hes', $data ?? [], null);
    ...
    */
     ...
     *
     * @param bool|null $delivery_service_hes Position item has delivery service HES
     *
     * @return self
     */
    public function setDeliveryServiceHes($delivery_service_hes)
    {
        if (is_null($delivery_service_hes)) {
            throw new \InvalidArgumentException('non-nullable delivery_service_hes cannot be null');
        }
