 ...
 */
class PositionItemReturnsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('occurred_time', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $position_item_id Sales position item ID
     *
     * @return self
     */
     ...
     * Sets occurred_time
     *
     * @param string|null $occurred_time Date when the last status was updated.
     *
     * @return self
     */
    public function setOccurredTime($occurred_time)
    {
        if (is_null($occurred_time)) {
            throw new \InvalidArgumentException('non-nullable occurred_time cannot be null');
        }
     ...
     * Sets details
     *
     * @param object|null $details UnionType: One of  ReturnAnnounced, Misdirected Return, Accepted Return, Rejected Return. This type is never returned to the client only the subtypes are
     *
     * @return self
     */
