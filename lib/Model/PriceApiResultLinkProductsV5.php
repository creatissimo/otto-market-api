 ...
 */
class PriceApiResultLinkProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceApiResultLink__Products-V5';
