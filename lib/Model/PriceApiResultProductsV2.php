 ...
 */
class PriceApiResultProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PriceApiResult__Products-V2';
    ...
    {
        $this->setIfExists('variation_prices', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Otto\Client\Model\SkuPricingProductsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\SkuPricingProductsV2[]|null $variation_prices variation_prices
     *
     * @return self
     */
    public function setVariationPrices($variation_prices)
    {
        if (is_null($variation_prices)) {
            throw new \InvalidArgumentException('non-nullable variation_prices cannot be null');
        }
