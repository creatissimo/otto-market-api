...
class PriceReductionResponsePriceReductionsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'total_price_reduction' => false,
		'invoice_price' => false,
		'price_reductions' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('total_price_reduction', $data ?? [], null);
        $this->setIfExists('invoice_price', $data ?? [], null);
        $this->setIfExists('price_reductions', $data ?? [], null);
    ...
    */
     ...
     * Sets sales_order_id
     *
     * @param string|null $sales_order_id salesOrderId for an item
     *
     * @return self
     */
    ...
    {
        if (is_null($total_price_reduction)) {
            throw new \InvalidArgumentException('non-nullable total_price_reduction cannot be null');
        }
    ...
    {
        if (is_null($invoice_price)) {
            throw new \InvalidArgumentException('non-nullable invoice_price cannot be null');
        }
    ...
    {
        if (is_null($price_reductions)) {
            throw new \InvalidArgumentException('non-nullable price_reductions cannot be null');
        }
     ...
     *
     * @param string|null $position_item_id positionItemId for an item
     *
     * @return self
     */
