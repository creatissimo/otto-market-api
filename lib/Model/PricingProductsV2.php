 ...
 */
class PricingProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Pricing__Products-V2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('norm_price_info', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets msrp
     *
     * @return \Otto\Client\Model\MonetaryAmountProductsV2|null
     */
     ...
     * Sets msrp
     *
     * @param \Otto\Client\Model\MonetaryAmountProductsV2|null $msrp msrp
     *
     * @return self
     */
     ...
     * Gets sale
     *
     * @return \Otto\Client\Model\SaleProductsV2|null
     */
     ...
     * Sets sale
     *
     * @param \Otto\Client\Model\SaleProductsV2|null $sale sale
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\NormPriceInfoProductsV2|null
     */
     ...
     *
     * @param \Otto\Client\Model\NormPriceInfoProductsV2|null $norm_price_info norm_price_info
     *
     * @return self
     */
    public function setNormPriceInfo($norm_price_info)
    {
        if (is_null($norm_price_info)) {
            throw new \InvalidArgumentException('non-nullable norm_price_info cannot be null');
        }
