 ...
 */
class ProductDescriptionProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductDescription__Products-V2';
    ...
    */
     ...
     * Sets product_line
     *
     * @param string|null $product_line Denotes the proper name of a product, like '501'. May contain a maximum of 50 characters. If provided, it must be identical for all variants of a product.
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $production_date Denotes the date of manufacture of a product variant.
     *
     * @return self
     */
     ...
     * Sets bullet_points
     *
     * @param string[]|null $bullet_points At least one bullet point must be provided. Up to five bullet points can be specified. May contain a minimum of 3 and a maximum of 180 characters.
     *
     * @return self
     */
     ...
     * Gets attributes
     *
     * @return \Otto\Client\Model\AttributeProductsV2[]|null
     */
     ...
     * Sets attributes
     *
     * @param \Otto\Client\Model\AttributeProductsV2[]|null $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return self
     */
