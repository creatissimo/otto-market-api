...
class ProductDescriptionProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['production_date'] = $data['production_date'] ?? null;
        $this->container['multi_pack'] = $data['multi_pack'] ?? null;
        $this->container['bundle'] = $data['bundle'] ?? null;
        $this->container['fsc_certified'] = $data['fsc_certified'] ?? null;
        $this->container['disposal'] = $data['disposal'] ?? null;
        $this->container['product_url'] = $data['product_url'] ?? null;
        $this->container['description'] = $data['description'] ?? null;
        $this->container['bullet_points'] = $data['bullet_points'] ?? null;
