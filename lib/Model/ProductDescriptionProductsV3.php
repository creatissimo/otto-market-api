...
class ProductDescriptionProductsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'attributes' => '\OpenAPI\Client\Model\AttributeProductsV3[]'
    ];
    ...
    */
     ...
     * Gets attributes
     *
     * @return \OpenAPI\Client\Model\AttributeProductsV3[]|null
     */
     ...
     * Sets attributes
     *
     * @param \OpenAPI\Client\Model\AttributeProductsV3[]|null $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return self
     */
