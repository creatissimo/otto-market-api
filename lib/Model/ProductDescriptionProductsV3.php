...
class ProductDescriptionProductsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets attributes
     *
     * @return \Otto\Client\Model\AttributeProductsV3[]|null
     */
     ...
     * Sets attributes
     *
     * @param \Otto\Client\Model\AttributeProductsV3[]|null $attributes Lists all the descriptive information about a product variant a partner can provide. Must be provided in the form of a key values pair. Will be validated against the AttributeDefinitions from Category endpoint provided by Otto market.
     *
     * @return self
     */
