 ...
 */
class ProductProcessProgressProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessProgress__Products-V2';
    ...
    */
     ...
     * Gets links
     *
     * @return \Otto\Client\Model\ProductProcessResultLinkProductsV2[]|null
     */
     ...
     * Sets links
     *
     * @param \Otto\Client\Model\ProductProcessResultLinkProductsV2[]|null $links a list of links that can be used to access detailed information about the process result
     *
     * @return self
     */
