...
class ProductProcessProgressProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'unchanged' => 'int',
        'ping_after' => '\DateTime',
        'links' => '\OpenAPI\Client\Model\ProductProcessResultLinkProductsV5[]'
    ];
    ...
    */
     ...
     * Gets links
     *
     * @return \OpenAPI\Client\Model\ProductProcessResultLinkProductsV5[]|null
     */
     ...
     * Sets links
     *
     * @param \OpenAPI\Client\Model\ProductProcessResultLinkProductsV5[]|null $links a list of links that can be used to access detailed information about the process result
     *
     * @return self
     */
