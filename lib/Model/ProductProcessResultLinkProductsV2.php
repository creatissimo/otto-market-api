 ...
 */
class ProductProcessResultLinkProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessResultLink__Products-V2';
