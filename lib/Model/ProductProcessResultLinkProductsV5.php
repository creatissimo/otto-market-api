 ...
 */
class ProductProcessResultLinkProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessResultLink__Products-V5';
