 ...
 */
class ProductProcessTaskErrorProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessTaskError__Products-V2';
     ...
     * Sets json_path
     *
     * @param string|null $json_path json_path
     *
     * @return self
     */
