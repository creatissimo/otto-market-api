 ...
 */
class ProductProcessTaskResultProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductProcessTaskResult__Products-V2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('url_to_shop_product', $data ?? [], null);
    ...
    */
     ...
     *
     * @param object|null $url_to_shop_product url_to_shop_product
     *
     * @return self
     */
    public function setUrlToShopProduct($url_to_shop_product)
    {
        if (is_null($url_to_shop_product)) {
            throw new \InvalidArgumentException('non-nullable url_to_shop_product cannot be null');
        }
     ...
     * Gets errors
     *
     * @return \Otto\Client\Model\ProductProcessTaskErrorProductsV2[]|null
     */
     ...
     * Sets errors
     *
     * @param \Otto\Client\Model\ProductProcessTaskErrorProductsV2[]|null $errors errors
     *
     * @return self
     */
