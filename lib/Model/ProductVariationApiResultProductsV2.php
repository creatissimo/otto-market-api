 ...
 */
class ProductVariationApiResultProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariationApiResult__Products-V2';
    ...
    {
        $this->setIfExists('product_variations', $data ?? [], null);
    ...
    */
     ...
     *
     * @return \Otto\Client\Model\ProductVariationProductsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\ProductVariationProductsV2[]|null $product_variations product_variations
     *
     * @return self
     */
    public function setProductVariations($product_variations)
    {
        if (is_null($product_variations)) {
            throw new \InvalidArgumentException('non-nullable product_variations cannot be null');
        }
