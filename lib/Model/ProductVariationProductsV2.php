 ...
 */
class ProductVariationProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariation__Products-V2';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offering_start_date', $data ?? [], null);
    ...
    */
     ...
     *
     * @param \DateTime|null $offering_start_date Date to which the product can be ordered via OTTO marketplace.
     *
     * @return self
     */
    public function setOfferingStartDate($offering_start_date)
    {
        if (is_null($offering_start_date)) {
            throw new \InvalidArgumentException('non-nullable offering_start_date cannot be null');
        }
     ...
     * Sets release_date
     *
     * @param \DateTime|null $release_date Date to which the product is released by the manufacturer, e.g. computer games.
     *
     * @return self
     */
     ...
     *
     * @param int|null $max_order_quantity The maximum allowed order quantity for an order.
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\ProductDescriptionProductsV2|null
     */
     ...
     *
     * @param \Otto\Client\Model\ProductDescriptionProductsV2|null $product_description product_description
     *
     * @return self
     */
     ...
     * Gets media_assets
     *
     * @return \Otto\Client\Model\MediaAssetProductsV2[]|null
     */
     ...
     * Sets media_assets
     *
     * @param \Otto\Client\Model\MediaAssetProductsV2[]|null $media_assets media_assets
     *
     * @return self
     */
     ...
     * Gets pricing
     *
     * @return \Otto\Client\Model\PricingProductsV2|null
     */
     ...
     * Sets pricing
     *
     * @param \Otto\Client\Model\PricingProductsV2|null $pricing pricing
     *
     * @return self
     */
     ...
     * Gets logistics
     *
     * @return \Otto\Client\Model\LogisticsProductsV2|null
     */
     ...
     * Sets logistics
     *
     * @param \Otto\Client\Model\LogisticsProductsV2|null $logistics logistics
     *
     * @return self
     */
