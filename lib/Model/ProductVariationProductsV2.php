...
class ProductVariationProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['offering_start_date'] = $data['offering_start_date'] ?? null;
        $this->container['release_date'] = $data['release_date'] ?? null;
        $this->container['max_order_quantity'] = $data['max_order_quantity'] ?? null;
        $this->container['product_description'] = $data['product_description'] ?? null;
        $this->container['media_assets'] = $data['media_assets'] ?? null;
