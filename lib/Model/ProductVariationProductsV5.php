 ...
 */
class ProductVariationProductsV5 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductVariation__Products-V5';
