...
self::TYPE_PARTIAL_REFUND,        ];
     ...
     * Sets line_items
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2[] $line_items List of specific position item ids of the order billed or reimbursed.In case of 'refund receipt for shipping costs only' the list can be empty.
     *
     * @return $this
     */
