...
class ReceiptReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['original_receipt_number'] = $data['original_receipt_number'] ?? null;
        $this->container['original_creation_date'] = $data['original_creation_date'] ?? null;
        ...
        $this->container['service_positions'] = $data['service_positions'] ?? null;
     ...
     * Sets line_items
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2[]|null $line_items List of specific position item ids of the order billed or reimbursed.In case of 'refund receipt for shipping costs only' the list can be empty.
     *
     * @return self
     */
