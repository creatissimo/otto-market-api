 ...
 */
class ReceiptReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Receipt__Receipts-V2';
    ...
    protected static array $openAPINullables = [
        'type' => false,
		'original_receipt_number' => false,
		'original_creation_date' => false,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('original_receipt_number', $data ?? [], null);
        $this->setIfExists('original_creation_date', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $original_receipt_number Unique identifier of the corresponding purchase receipt with which the reimbursed position item was billed. Only filled in case of refund or partial refund receipts. Printed on the purchase receipt and used to identified the corresponding purchase receipt.
     *
     * @return self
     */
    public function setOriginalReceiptNumber($original_receipt_number)
    {
        if (is_null($original_receipt_number)) {
            throw new \InvalidArgumentException('non-nullable original_receipt_number cannot be null');
        }
     ...
     *
     * @param \DateTime|null $original_creation_date Creation date of the corresponding purchase receipt. This is not available for purchase receipt.
     *
     * @return self
     */
    public function setOriginalCreationDate($original_creation_date)
    {
        if (is_null($original_creation_date)) {
            throw new \InvalidArgumentException('non-nullable original_creation_date cannot be null');
        }
     ...
     * Sets url
     *
     * @param string|null $url API call to get corresponding PDF receipts, if available.
     *
     * @return self
     */
     ...
     * Sets shipment_date
     *
     * @param \DateTime|null $shipment_date Date and time when the position items handed over to the carrier for delivery to the customer. Only available for purchase receipts.
     *
     * @return self
     */
     ...
     *
     * @param string|null $payment_provider Possible values can be \"OTTOPAYMENTS\" or \"PLAZA\", where \"PLAZA\" means it can be Computop for \"Kreditkarte\" or otherwise it is Ratepay.
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\DeliveryAddressReceiptsV2|null
     */
     ...
     *
     * @param \Otto\Client\Model\DeliveryAddressReceiptsV2|null $delivery_address delivery_address
     *
     * @return self
     */
     ...
     * Gets line_items
     *
     * @return \Otto\Client\Model\LineItemReceiptsV2[]|null
     */
     ...
     * Sets line_items
     *
     * @param \Otto\Client\Model\LineItemReceiptsV2[]|null $line_items List of specific position item ids of the order billed or reimbursed.In case of service only purchase/refund receipt and shipping cost only refund receipt, the list can be empty.
     *
     * @return self
     */
     ...
     *
     * @return \Otto\Client\Model\ServicePositionInfoReceiptsV2[]|null
     */
     ...
     *
     * @param \Otto\Client\Model\ServicePositionInfoReceiptsV2[]|null $service_positions service_positions
     *
     * @return self
     */
     ...
     * Gets shipping_cost
     *
     * @return \Otto\Client\Model\ShippingCostReceiptsV2|null
     */
     ...
     * Sets shipping_cost
     *
     * @param \Otto\Client\Model\ShippingCostReceiptsV2|null $shipping_cost shipping_cost
     *
     * @return self
     */
