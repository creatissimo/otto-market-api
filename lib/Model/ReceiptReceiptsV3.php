...
class ReceiptReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const PARTIAL_REFUND_TYPE_ESCALATION = 'REFUND_ESCALATION';
    public const PARTIAL_REFUND_TYPE_PARTIAL_AMOUNT_AFTER_SERVICE_CANCELLATION = 'REFUND_PARTIAL_AMOUNT_AFTER_SERVICE_CANCELLATION';
    ...
    */
     ...
     *
     * @param object|null $totals_gross_amount Gross amounts of totals summed up over all prices. Only available on receipts of receiptType PURCHASE
     *
     * @return self
     */
