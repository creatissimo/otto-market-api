...
class ReceiptReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets shipment_date
     *
     * @param \DateTime|null $shipment_date Date when physical items of this receipt were handed over to the carrier to be delivered to the customer (UTC in ISO-8601 format). Only available on receipts of receiptType PURCHASE.
     *
     * @return self
     */
     ...
     *
     * @param string|null $linked_receipt_number Human-readable identifier of linked receipt. In case of receiptType PARTIAL_REFUND or REFUND it is the receiptINumber of purchase receipt.  ATTENTION: In previous version the information was called originalReceiptNumber
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $linked_creation_date Creation date of linked receipt (UTC in ISO-8601 format). Only available if there is a linked receipt.  ATTENTION: In previous version the information was called originalCreatedDate
     *
     * @return self
     */
