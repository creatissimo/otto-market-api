 ...
 */
class RejectedPartnerReturnV2ReturnsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RejectedPartnerReturnV2__Returns-V2';
