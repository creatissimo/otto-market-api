...
class ReturnShipmentReturnShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
        'return_shipment_id' => false,
        'created_at' => false,
        'tracking_key' => false,
        'return_position_items' => false,
        'states' => false
    ];
    ...
    {
        $this->setIfExists('return_shipment_id', $data ?? [], null);
        $this->setIfExists('created_at', $data ?? [], null);
        $this->setIfExists('tracking_key', $data ?? [], null);
        $this->setIfExists('return_position_items', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['return_position_items']) < 1)) {
            $invalidProperties[] = "invalid value for 'return_position_items', number of items must be greater than or equal to 1.";
        }
    ...
    {
        if (is_null($return_shipment_id)) {
            throw new \InvalidArgumentException('non-nullable return_shipment_id cannot be null');
        }
    ...
    {
        if (is_null($return_position_items)) {
            throw new \InvalidArgumentException('non-nullable return_position_items cannot be null');
        }


        if ((count($return_position_items) < 1)) {
            throw new \InvalidArgumentException('invalid length for $return_position_items when calling ReturnShipmentReturnShipmentsV1., number of items must be greater than or equal to 1.');
        }
