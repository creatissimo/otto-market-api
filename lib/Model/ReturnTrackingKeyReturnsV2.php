 ...
 */
class ReturnTrackingKeyReturnsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnTrackingKey__Returns-V2';
