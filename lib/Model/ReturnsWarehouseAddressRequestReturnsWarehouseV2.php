 ...
 */
class ReturnsWarehouseAddressRequestReturnsWarehouseV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ReturnsWarehouseAddressRequest__ReturnsWarehouse-V2';
    ...
    */
     ...
     *
     * @param bool|null $is_misdirected_address Flag to indicate whether the returnWarehouse is a misdirected address or not. One address should be marked as 'isMisdirectedAddress' to handle misdirected returns. Default value is false.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $is_business_address Flag to indicate whether the returnWarehouse is a business address or not.Required field if returnWarehouseType=NATIONAL.
     *
     * @return self
     */
