 ...
 */
class SaleProductsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Sale__Products-V2';
     ...
     * Sets sale_price
     *
     * @param \Otto\Client\Model\MonetaryAmountProductsV2|null $sale_price sale_price
     *
     * @return self
     */
     ...
     * Sets start_date
     *
     * @param \DateTime|null $start_date The start date for the sales.
     *
     * @return self
     */
     ...
     * Sets end_date
     *
     * @param \DateTime|null $end_date The end date for the sales.
     *
     * @return self
     */
