 ...
 */
class ServicePositionInfoReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServicePositionInfo__Receipts-V2';
    ...
    protected static $openAPITypes = [
        'unit_price' => '\Otto\Client\Model\ServicePositionInfoReceiptsV2UnitPrice',
        'vat_rate' => 'float',
        'quantity' => 'int',
        'total' => '\Otto\Client\Model\ServicePositionInfoReceiptsV2Total',
        'service_name' => 'string',
        'service_type' => 'string',
    ...
    protected static array $openAPINullables = [
		...
		'promotion' => false,
		'service_position_items' => false,
		'linked_product_receipt_number' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('service_position_items', $data ?? [], null);
        $this->setIfExists('linked_product_receipt_number', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets unit_price
     *
     * @return \Otto\Client\Model\ServicePositionInfoReceiptsV2UnitPrice
     */
     ...
     * Sets unit_price
     *
     * @param \Otto\Client\Model\ServicePositionInfoReceiptsV2UnitPrice $unit_price unit_price
     *
     * @return self
     */
     ...
     * Gets total
     *
     * @return \Otto\Client\Model\ServicePositionInfoReceiptsV2Total
     */
     ...
     * Sets total
     *
     * @param \Otto\Client\Model\ServicePositionInfoReceiptsV2Total $total total
     *
     * @return self
     */
    ...
    {
        if (is_null($service_position_items)) {
            throw new \InvalidArgumentException('non-nullable service_position_items cannot be null');
        }
     ...
     *
     * @param string|null $linked_product_receipt_number Human-readable identifier refers to the purchase receipt the linked item was billed. Displayed only if item is billed with another receipt.
     *
     * @return self
     */
    public function setLinkedProductReceiptNumber($linked_product_receipt_number)
    {
        if (is_null($linked_product_receipt_number)) {
            throw new \InvalidArgumentException('non-nullable linked_product_receipt_number cannot be null');
        }
