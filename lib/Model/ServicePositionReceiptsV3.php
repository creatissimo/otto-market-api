...
class ServicePositionReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SERVICE_TYPE_SUBSCRIPTION = 'SUBSCRIPTION';
    public const SERVICE_TYPE_DISPOSAL = 'DISPOSAL';
    public const SERVICE_TYPE_ASSEMBLY = 'ASSEMBLY';
    public const SERVICE_TYPE_DISPOSAL_FURNITURE = 'DISPOSAL_FURNITURE';
    public const SERVICE_TYPE_CONSULTING = 'CONSULTING';
    public const SERVICE_TYPE_INSTALLATION = 'INSTALLATION';
    public const SERVICE_TYPE_WARRANTY = 'WARRANTY';
    public const SERVICE_TYPE_MARKETING = 'MARKETING';
    public const SERVICE_TYPE_LICENCE = 'LICENCE';
    ...
    */
     ...
     * Sets line_number
     *
     * @param int|null $line_number Number of line item in which the information is printed on the pdf document of the receipt.  This information is not reliably provided for older receipts
     *
     * @return self
     */
     ...
     * Sets service_type
     *
     * @param string|null $service_type Categorization that classifies services according to their main characteristics. Services of the same type are often treated in the same way
     *
     * @return self
     */
     ...
     *
     * @param string|null $expected_performance_period Vague performance date. As the exact date is not known when generating the receipt, this information gives an indication when the service is expected to be fulfilled
     *
     * @return self
     */
