...
/**
 * ServiceRelationsReceiptsV3 Class Doc Comment
 *
 * @category Class
 ...
 */
class ServiceRelationsReceiptsV3 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ServiceRelations__Receipts-V3';
    ...
    protected static array $openAPINullables = [
        'service_position_item_id' => false,
    ...
    {
        $this->setIfExists('service_position_item_id', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($service_position_item_id)) {
            throw new \InvalidArgumentException('non-nullable service_position_item_id cannot be null');
        }
