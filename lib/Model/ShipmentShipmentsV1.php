...
class ShipmentShipmentsV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tracking_key'] = $data['tracking_key'] ?? null;
        $this->container['ship_date'] = $data['ship_date'] ?? null;
        $this->container['ship_from_address'] = $data['ship_from_address'] ?? null;
        $this->container['position_items'] = $data['position_items'] ?? null;
    }
    ...
    public function setPositionItems($position_items)
    {
        ...
        if (!is_null($position_items) && (count($position_items) < 1)) {
