...
class ShippingCostReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['delivery_fee_standard'] = $data['delivery_fee_standard'] ?? null;
        $this->container['delivery_fee_freight_surcharge'] = $data['delivery_fee_freight_surcharge'] ?? null;
    }
