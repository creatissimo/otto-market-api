 ...
 */
class ShippingCostReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShippingCost__Receipts-V2';
    ...
    protected static array $openAPINullables = [
        'delivery_fee_standard' => false,
		'delivery_fee_freight_surcharge' => false
    ];
    ...
    {
        $this->setIfExists('delivery_fee_standard', $data ?? [], null);
        $this->setIfExists('delivery_fee_freight_surcharge', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($delivery_fee_standard)) {
            throw new \InvalidArgumentException('non-nullable delivery_fee_standard cannot be null');
        }
    ...
    {
        if (is_null($delivery_fee_freight_surcharge)) {
            throw new \InvalidArgumentException('non-nullable delivery_fee_freight_surcharge cannot be null');
        }
