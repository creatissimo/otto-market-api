 ...
 */
class SuggestedAddressReturnsWarehouseV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuggestedAddress__ReturnsWarehouse-V2';
    ...
    */
     ...
     * Sets district
     *
     * @param string|null $district The district name if present.
     *
     * @return self
     */
     ...
     * Sets street
     *
     * @param string|null $street The street name when it is not a business address.
     *
     * @return self
     */
     ...
     * Sets house_number
     *
     * @param string|null $house_number The houseNumber name when it is not a business address.
     *
     * @return self
     */
