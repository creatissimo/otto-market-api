...
class TotalReceiptsV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets gross
     *
     * @param object $gross Total gross value of the receipt.
     *
     * @return self
     */
     ...
     * Sets net
     *
     * @param object $net Total net value of the receipt.
     *
     * @return self
     */
     ...
     * Sets vat
     *
     * @param array<string,object> $vat Total vat values of the receipt.
     *
     * @return self
     */
     ...
     * Sets amount_due
     *
     * @param object $amount_due Gross due amount.
     *
     * @return self
     */
