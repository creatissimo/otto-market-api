...
class TrackingInfoOrdersV4 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('carrier_service_code', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $carrier_service_code The service code provided by the carrier
     *
     * @return self
     */
    public function setCarrierServiceCode($carrier_service_code)
    {
        if (is_null($carrier_service_code)) {
            throw new \InvalidArgumentException('non-nullable carrier_service_code cannot be null');
        }
     ...
     *
     * @param string|null $tracking_number The tracking number provided by the carrier
     *
     * @return self
     */
