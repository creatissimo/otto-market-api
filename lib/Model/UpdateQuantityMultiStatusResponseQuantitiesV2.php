 ...
 */
class UpdateQuantityMultiStatusResponseQuantitiesV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateQuantityMultiStatusResponse__Quantities-V2';
