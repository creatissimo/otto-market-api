...
class Total implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'gross' => '\Otto\Client\Receipts\Model\MonetaryAmount',
'net' => '\Otto\Client\Receipts\Model\MonetaryAmount',
'vat' => 'map[string,\Otto\Client\Receipts\Model\MonetaryAmount]',
'amount_due' => '\Otto\Client\Receipts\Model\MonetaryAmount'    ];
...
'amount_due' => 'getAmountDue'    ];
     ...
     * Sets gross
     *
     * @param \Otto\Client\Receipts\Model\MonetaryAmount $gross gross
     *
     * @return $this
     */
     ...
     * Sets net
     *
     * @param \Otto\Client\Receipts\Model\MonetaryAmount $net net
     *
     * @return $this
     */
     ...
     * Gets vat
     *
     * @return map[string,\Otto\Client\Receipts\Model\MonetaryAmount]
     */
     ...
     * Sets vat
     *
     * @param map[string,\Otto\Client\Receipts\Model\MonetaryAmount] $vat Total vat values (7% and 19%) of the receipt.
     *
     * @return $this
     */
     ...
     * Sets amount_due
     *
     * @param \Otto\Client\Receipts\Model\MonetaryAmount $amount_due amount_due
     *
     * @return $this
     */
